    ...
    public void Skill_Setting(bool b)
    {
        ...
        else  //검 장착
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                {
                    Skill_Set.Skill_Icons[i].GetComponent<Skill_Icon>().Skill_Data = transform.GetChild(1).GetComponentInChildren<Equipment_Icon>().Equipment_Data.Equipped_Obes[i].Skill_Data;
